define("handy/autocomplete/1.0.0/js/autocomplete-debug", [ "$-debug", "arale/widget/1.0.3/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug", "handy/base/1.0.0/js/detect-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var Widget = require("arale/widget/1.0.3/widget-debug");
    var Detect = require("handy/base/1.0.0/js/detect-debug");
